...
👋 ${sinhalaGreeting} *${pushname}* ඔබව *𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 V.4* බෝට් *MENU* වෙත සාදරයෙන් පිළිගන්නවා... 🙏`;
    ...
    // Send PDF document above the menu (as shown in screenshot)
    const menuPdfUrl = 'https://www.w3.org/WAI/WCAG21/Techniques/pdf/PDF1.pdf'; // ← ඔබේ PDF URL එක මෙතන දාන්න
    await socket.sendMessage(sender, {
      document: { url: menuPdfUrl },
      mimetype: 'application/pdf',
      fileName: `𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 🇱🇰 📁.pdf`,
      pageCount: 9999,
