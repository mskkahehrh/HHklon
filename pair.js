...
🥏 _Your fast and reliable all-in-one WhatsApp assistant._`;
    ...
    const sections = [{
      ...
      highlight_label: "BOT MENU",
      rows: [
        { header: "Download", title: "Download", description: "View download command", id: `${config.PREFIX}downloadmenu` },
        { header: "Fun",      title: "Fun",      description: "View fun command",      id: `${config.PREFIX}funmenu` },
        { header: "Search",   title: "Search",   description: "View search command",   id: `${config.PREFIX}searchmenu` },
        { header: "Group",    title: "Group",    description: "View group command",    id: `${config.PREFIX}groupmenu` },
        { header: "Owner",    title: "Owner",    description: "View owner command",    id: `${config.PREFIX}ownermenu` },
        { header: "Ai",       title: "Ai",       description: "View ai command",       id: `${config.PREFIX}aimenu` },
        { header: "Other",    title: "Other",    description: "View other command",    id: `${config.PREFIX}othermenu` },
        { header: "Main",     title: "Main",     description: "View main command",     id: `${config.PREFIX}mainmenu` },
        { header: "News",     title: "News",     description: "View news command",     id: `${config.PREFIX}newsmenu` }
      ]
    }];
