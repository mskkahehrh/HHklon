...
`𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 ᴄᴏɴɴᴇᴄᴛᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ 🥷🇱🇰\n*• \`ᴠᴇʀꜱɪᴏɴ\` : ᴠ4.0.0*\n*• \`ʙᴏᴛ ᴄᴏɴɴᴇᴄᴛ ɴʙ\` : ${number}*\n*• \`ᴘᴏᴡᴇʀᴇᴅ ʙʏ\` : 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 𝐕.4 🥷🇱🇰*\n\n*•Hy Hy 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 𝐕.4 වේත ඔයාව සාදරයෙන් පිලිගන්නවා.......🥹❤️‍🩹*\n\n_*ඉතිම් ලස්සන ලමයො 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 𝐕.4 𝗠𝗜𝗡𝗜 𝗕𝗢𝗧 ගැන ඔයාලාට තියේන අදහස් අනිවාරෙන් කියන්න ඔනේ හරිද 🌚💗*_\n\n*🌐 ᴡᴇʙ ꜱɪᴛᴇ :*\n> https://ashiya-md-v4-mini-bot.vercel.app/`,
          ...
          try {
            ...
            // ── Owner contact numbers message ──
            await delay(1500);
            await socket.sendMessage(userJid, {
              contacts: {
                displayName: 'SL NETHU MAX and 2 other contacts',
                contacts: [
                  {
                    vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:SL NETHU MAX\nTEL;type=CELL;type=VOICE;waid=947746793356:+94 7746793356\nEND:VCARD`
                  },
                  {
                    vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:SHALA MD BETA\nTEL;type=CELL;type=VOICE;waid=94785457011:+94 785457011\nEND:VCARD`
                  },
                  {
                    vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:ASHIYA MD OWNER\nTEL;type=CELL;type=VOICE;waid=94781332957:+94 781332957\nEND:VCARD`
                  }
                ]
              }
            });
