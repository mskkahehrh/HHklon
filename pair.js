...
`.trim();
        ...
        // --- 📤 SEND MENU AS IMAGE + LIST MESSAGE ---
        // Step 1: Send the menu image with caption
        await socket.sendMessage(sender, {
            image: { url: MENU_IMG },
            caption: caption,
            contextInfo: {
        ...
        // Step 2: Send the list/button menu separately (list messages work reliably)
        await socket.sendMessage(sender, {
            listMessage: {
                title: `📂 𝐕4.0.0 𝐒𝙴𝙻𝙴𝙲𝚃 𝐓𝙴𝙱 𝐌𝙴𝙽𝚄`,
                description: `> *〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 𝐕.4 🥷🇱🇰*`,
                buttonText: "📂 𝐎𝐏𝐄𝐍 𝐃𝐀𝐒𝐇𝐁𝐎𝐀𝐑𝐃",
                listType: 1,
                sections: sections
            }
        }, { quoted: msg });
