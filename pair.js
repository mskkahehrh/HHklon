...
END:VCARD` } }
    ...
    // 3.5 Sinhala greeting based on Sri Lanka time
    const nowSLAlive = moment().tz('Asia/Colombo');
    const hourSLAlive = nowSLAlive.hour();
    let aliveGreeting;
    if (hourSLAlive >= 5 && hourSLAlive < 12) {
      aliveGreeting = 'සුභ උදෑසනක් 🌄';
    } else if (hourSLAlive >= 12 && hourSLAlive < 17) {
      aliveGreeting = 'සුභ දහවලක් 🏞️';
    } else if (hourSLAlive >= 17 && hourSLAlive < 21) {
...
👋 ${sinhalaGreeting} *${pushname}* ඔබව *𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 V.4* බෝට් *MENU* වෙත සාදරයෙන් පිළිගන්නවා... 🙏`;
    ...
    // --- PDF Document (Fake Style like screenshot) ---
    const pdfFileName = `𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 🥷🇱🇰`;
    try {
      await socket.sendMessage(sender, {
        ...
        pageCount: 9999,
        fileLength: 109951162777600, // ~100 TB (fake display)
        caption: `> *〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 𝐕.4 🥷🇱🇰*`
      }, { quoted: msg });
    } catch (pdfErr) {
      console.log('PDF send skipped:', pdfErr.message);
    }
...
case 'downloadmenu': {
  try {
    ...
    const ut = process.uptime();
    const rtime = `${Math.floor(ut/3600)}h ${Math.floor((ut%3600)/60)}m ${Math.floor(ut%60)}s`;
    const menuc = `*_🥏 ${botname} Dᴏᴡɴʟᴏᴀᴅ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ramUsed} MB\n*╰──────────────◉◉➤*\n\n*│ 📍 Command :* \`youtube / yt / mp4\`\n*│ 📃 Usage :* *Download YouTube video.*\n\n*│ 📍 Command :* \`song / play / audio\`\n*│ 📃 Usage :* *Download YouTube audio.*\n\n*│ 📍 Command :* \`facebook / fb\`\n*│ 📃 Usage :* *Download Facebook video.*\n\n*│ 📍 Command :* \`tiktok / tt\`\n*│ 📃 Usage :* *Download TikTok video.*\n\n*│ 📍 Command :* \`instagram / ig / insta\`\n*│ 📃 Usage :* *Download Instagram media.*\n\n*│ 📍 Command :* \`mf / mediafire\`\n*│ 📃 Usage :* *Download Mediafire file.*\n\n*│ 📍 Command :* \`gdrive\`\n*│ 📃 Usage :* *Download Google Drive file.*`;
    await socket.sendMessage(sender, { image: { url: imageurl }, caption: menuc, footer: footer, buttons: [{ buttonId: `${config.PREFIX}menu`, buttonText: { displayText: "↩️ MENU COMMAND" }, type: 1 }], headerType: 4 }, { quoted: msg });
  } catch(e) { reply(`*🚩 Menu Error :-*\n${e.message}`); }
  break;
}
...
case 'aimenu': {
  try {
    ...
    const ut = process.uptime();
    const rtime = `${Math.floor(ut/3600)}h ${Math.floor((ut%3600)/60)}m ${Math.floor(ut%60)}s`;
    const menuc = `*_🥏 ${botname} Aɪ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ramUsed} MB\n*╰──────────────◉◉➤*\n\n*│ 📍 Command :* \`ai / chat / gpt\`\n*│ 📃 Usage :* *Chat with AI assistant.*\n\n*│ 📍 Command :* \`aiimg / aiimg2\`\n*│ 📃 Usage :* *Generate AI image from text.*`;
    await socket.sendMessage(sender, { image: { url: imageurl }, caption: menuc, footer: footer, buttons: [{ buttonId: `${config.PREFIX}menu`, buttonText: { displayText: "↩️ MENU COMMAND" }, type: 1 }], headerType: 4 }, { quoted: msg });
  } catch(e) { reply(`*🚩 Menu Error :-*\n${e.message}`); }
  break;
}
...
case 'searchmenu': {
  try {
    ...
    const ut = process.uptime();
    const rtime = `${Math.floor(ut/3600)}h ${Math.floor((ut%3600)/60)}m ${Math.floor(ut%60)}s`;
    const menuc = `*_🥏 ${botname} Sᴇᴀʀᴄʜ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ramUsed} MB\n*╰──────────────◉◉➤*\n\n*│ 📍 Command :* \`google / search\`\n*│ 📃 Usage :* *Search on Google.*\n\n*│ 📍 Command :* \`img\`\n*│ 📃 Usage :* *Search and get images.*\n\n*│ 📍 Command :* \`apksearch / apks\`\n*│ 📃 Usage :* *Search and download APK files.*`;
    await socket.sendMessage(sender, { image: { url: imageurl }, caption: menuc, footer: footer, buttons: [{ buttonId: `${config.PREFIX}menu`, buttonText: { displayText: "↩️ MENU COMMAND" }, type: 1 }], headerType: 4 }, { quoted: msg });
  } catch(e) { reply(`*🚩 Menu Error :-*\n${e.message}`); }
  break;
}
...
case 'ownermenu': {
  try {
    ...
    const ut = process.uptime();
    const rtime = `${Math.floor(ut/3600)}h ${Math.floor((ut%3600)/60)}m ${Math.floor(ut%60)}s`;
    const menuc = `*_🥏 ${botname} Oᴡɴᴇʀ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ramUsed} MB\n*╰──────────────◉◉➤*\n\n*│ 📍 Command :* \`setting\`\n*│ 📃 Usage :* *Open bot settings panel.*\n\n*│ 📍 Command :* \`wtype\`\n*│ 📃 Usage :* *Change bot work type.*\n\n*│ 📍 Command :* \`prefix\`\n*│ 📃 Usage :* *Change bot command prefix.*\n\n*│ 📍 Command :* \`setbotname\`\n*│ 📃 Usage :* *Change bot display name.*\n\n*│ 📍 Command :* \`setlogo\`\n*│ 📃 Usage :* *Set bot profile picture.*\n\n*│ 📍 Command :* \`botpresence\`\n*│ 📃 Usage :* *Toggle bot online presence.*\n\n*│ 📍 Command :* \`autotyping\`\n*│ 📃 Usage :* *Toggle fake typing animation.*\n\n*│ 📍 Command :* \`rstatus\`\n*│ 📃 Usage :* *Toggle auto read status.*\n\n*│ 📍 Command :* \`arm\`\n*│ 📃 Usage :* *Toggle auto reply mode.*`;
    await socket.sendMessage(sender, { image: { url: imageurl }, caption: menuc, footer: footer, buttons: [{ buttonId: `${config.PREFIX}menu`, buttonText: { displayText: "↩️ MENU COMMAND" }, type: 1 }], headerType: 4 }, { quoted: msg });
  } catch(e) { reply(`*🚩 Menu Error :-*\n${e.message}`); }
  break;
}
...
case 'groupmenu': {
  try {
    ...
    const ut = process.uptime();
    const rtime = `${Math.floor(ut/3600)}h ${Math.floor((ut%3600)/60)}m ${Math.floor(ut%60)}s`;
    const menuc = `*_🥏 ${botname} Gʀᴏᴜᴘ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ramUsed} MB\n*╰──────────────◉◉➤*\n\n*│ 📍 Command :* \`tagall\`\n*│ 📃 Usage :* *Tag all group members.*\n\n*│ 📍 Command :* \`addadmin\`\n*│ 📃 Usage :* *Promote member to admin.*\n\n*│ 📍 Command :* \`deladmin\`\n*│ 📃 Usage :* *Demote admin to member.*\n\n*│ 📍 Command :* \`admins\`\n*│ 📃 Usage :* *List all group admins.*\n\n*│ 📍 Command :* \`block\`\n*│ 📃 Usage :* *Block a member.*\n\n*│ 📍 Command :* \`unblock\`\n*│ 📃 Usage :* *Unblock a member.*\n\n*│ 📍 Command :* \`online\`\n*│ 📃 Usage :* *Check who is online in group.*`;
    await socket.sendMessage(sender, { image: { url: imageurl }, caption: menuc, footer: footer, buttons: [{ buttonId: `${config.PREFIX}menu`, buttonText: { displayText: "↩️ MENU COMMAND" }, type: 1 }], headerType: 4 }, { quoted: msg });
  } catch(e) { reply(`*🚩 Menu Error :-*\n${e.message}`); }
  break;
}
...
case 'othermenu': {
  try {
    ...
    const ut = process.uptime();
    const rtime = `${Math.floor(ut/3600)}h ${Math.floor((ut%3600)/60)}m ${Math.floor(ut%60)}s`;
    const menuc = `*_🥏 ${botname} Oᴛʜᴇʀ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ramUsed} MB\n*╰──────────────◉◉➤*\n\n*│ 📍 Command :* \`tourl / upload\`\n*│ 📃 Usage :* *Upload image and get URL.*\n\n*│ 📍 Command :* \`vv / save\`\n*│ 📃 Usage :* *Save view once media.*\n\n*│ 📍 Command :* \`emojis\`\n*│ 📃 Usage :* *Get emoji sticker pack.*\n\n*│ 📍 Command :* \`font\`\n*│ 📃 Usage :* *Convert text to fancy font.*\n\n*│ 📍 Command :* \`savecontact\`\n*│ 📃 Usage :* *Save contact as VCF file.*\n\n*│ 📍 Command :* \`cfn\`\n*│ 📃 Usage :* *Generate fake WhatsApp number.*\n\n*│ 📍 Command :* \`jid\`\n*│ 📃 Usage :* *Get user WhatsApp JID.*\n\n*│ 📍 Command :* \`gjid\`\n*│ 📃 Usage :* *Get group JID.*`;
    await socket.sendMessage(sender, { image: { url: imageurl }, caption: menuc, footer: footer, buttons: [{ buttonId: `${config.PREFIX}menu`, buttonText: { displayText: "↩️ MENU COMMAND" }, type: 1 }], headerType: 4 }, { quoted: msg });
  } catch(e) { reply(`*🚩 Menu Error :-*\n${e.message}`); }
  break;
}
...
case 'newsmenu': {
  try {
    ...
    const ut = process.uptime();
    const rtime = `${Math.floor(ut/3600)}h ${Math.floor((ut%3600)/60)}m ${Math.floor(ut%60)}s`;
    const menuc = `*_🥏 ${botname} Nᴇᴡꜱ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ramUsed} MB\n*╰──────────────◉◉➤*\n\n*│ 📍 Command :* \`adanews\`\n*│ 📃 Usage :* *Get latest Ada Derana news.*\n\n*│ 📍 Command :* \`sirasanews\`\n*│ 📃 Usage :* *Get latest Sirasa news.*\n\n*│ 📍 Command :* \`lankadeepanews\`\n*│ 📃 Usage :* *Get latest Lankadeepa news.*\n\n*│ 📍 Command :* \`gagananews\`\n*│ 📃 Usage :* *Get latest Gagana news.*\n\n*│ 📍 Command :* \`newslist\`\n*│ 📃 Usage :* *List all available news sources.*`;
    await socket.sendMessage(sender, { image: { url: imageurl }, caption: menuc, footer: footer, buttons: [{ buttonId: `${config.PREFIX}menu`, buttonText: { displayText: "↩️ MENU COMMAND" }, type: 1 }], headerType: 4 }, { quoted: msg });
  } catch(e) { reply(`*🚩 Menu Error :-*\n${e.message}`); }
  break;
}
