        ...
        const sections = [
            {
                ...
                rows: [
                    ...
                    { title: "❄ ᴀɪ ᴄᴏᴍᴍᴀɴᴅ", description: "𝙰𝚂𝙷𝙸𝚈𝙰-𝙼𝙳 ᴠ.4.0.0 ᴀɪ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}aimenu` },
                    { title: "❄ ꜱᴇᴀʀᴄʜ ᴄᴏᴍᴍᴀɴᴅ", description: "𝙰𝚂𝙷𝙸𝚈𝙰-𝙼𝙳 ᴠ.4.0.0 ꜱᴇᴀʀᴄʜ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}searchmenu` },
                    { title: "❄ ꜰᴜɴ ᴄᴏᴍᴍᴀɴᴅ", description: "𝙰𝚂𝙷𝙸𝚈𝙰-𝙼𝙳 ᴠ.4.0.0 ꜰᴜɴ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}funmenu` }
                ]
            },
            {
                title: "𝙰𝚂𝙷𝙸𝚈𝙰-𝙼𝙳 ᴍᴇɴᴜ ʟɪꜱᴛ 🙌",
                rows: [
                    { title: "❄ ɢʀᴏᴜᴘ ᴄᴏᴍᴍᴀɴᴅ", description: "𝙰𝚂𝙷𝙸𝚈𝙰-𝙼𝙳 ᴠ.4.0.0 ɢʀᴏᴜᴘ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}groupmenu` },
                    { title: "❄ ᴍᴀɪɴ ᴄᴏᴍᴍᴀɴᴅ", description: "𝙰𝚂𝙷𝙸𝚈𝙰-𝙼𝙳 ᴠ.4.0.0 ᴍᴀɪɴ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}mainmenu` },
                    { title: "❄ ᴏᴡɴᴇʀ ᴄᴏᴍᴍᴀɴᴅ", description: "𝙰𝚂𝙷𝙸𝚈𝙰-𝙼𝙳 ᴠ.4.0.0 ᴏᴡɴᴇʀ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}ownermenu` },
                    { title: "❄ ᴏᴛʜᴇʀ ᴄᴏᴍᴍᴀɴᴅ", description: "𝙰𝚂𝙷𝙸𝚈𝙰-𝙼𝙳 ᴠ.4.0.0 ᴏᴛʜᴇʀ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}othermenu` },
...
case 'bothelp': {
  try {
    ...
    const buttons = [
      { buttonId: config.PREFIX + 'helpen', buttonText: { displayText: 'English 🇬🇧' }, type: 1 },
      { buttonId: config.PREFIX + 'helpsi', buttonText: { displayText: 'සිංහල 🇱🇰' }, type: 1 }
    ];
...
case 'helpsi': {
  try {
    ...
    const buttons = [
      { buttonId: config.PREFIX + 'generalhelpsi', buttonText: { displayText: 'සාමාන්‍ය උපකාර ❓' }, type: 1 },
      { buttonId: config.PREFIX + 'owner', buttonText: { displayText: 'අපහා සම්බන්ද වන්න 📞' }, type: 1 },
      { buttonId: config.PREFIX + 'menu', buttonText: { displayText: 'විධාන ලැයිස්තුව 📜' }, type: 1 }
    ];
    ...
    console.error('HelpSI command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Error :*\n${e.message}` }, { quoted: msg });
  }
  break;
}
...
case 'helpen': {
  try {
    ...
    const buttons = [
      { buttonId: config.PREFIX + 'generalhelpen', buttonText: { displayText: 'General Help ❓' }, type: 1 },
      { buttonId: config.PREFIX + 'owner', buttonText: { displayText: 'Contact Us 📞' }, type: 1 },
      { buttonId: config.PREFIX + 'menu', buttonText: { displayText: 'Command Menu 📜' }, type: 1 }
    ];
    ...
    console.error('HelpEN command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Error :*\n${e.message}` }, { quoted: msg });
  }
  break;
}

// ==================== GENERAL HELP SI (from GGKO) ====================
case 'generalhelpsi': {
  try {
    await socket.sendMessage(sender, { react: { text: "🆘", key: msg.key } });
    ...
    const buttons1 = [
      { buttonId: config.PREFIX + 'helpsi', buttonText: { displayText: 'උපකාර මධ්‍යස්ථානය 🔙' }, type: 1 }
    ];
    ...
    console.error('GeneralHelpSI command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Error :*\n${e.message}` }, { quoted: msg });
  }
  break;
}

// ==================== GENERAL HELP EN (from GGKO) ====================
case 'generalhelpen': {
  try {
    await socket.sendMessage(sender, { react: { text: "🆘", key: msg.key } });
    ...
    const buttons1 = [
      { buttonId: config.PREFIX + 'helpen', buttonText: { displayText: 'Help Center 🔙' }, type: 1 }
    ];
    ...
    console.error('GeneralHelpEN command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Error :*\n${e.message}` }, { quoted: msg });
  }
  break;
}
...
case 'mainmenu': {
  try {
    ...
    const { footer, imageurl, botname, version } = ownerdata;

    const uptime = process.uptime();
    const h = Math.floor(uptime / 3600), m = Math.floor((uptime % 3600) / 60), s = Math.floor(uptime % 60);
    const rtime = `${h}h ${m}m ${s}s`;
    const ram = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)} MB`;

    let menuc = `*_🥏 ${botname} Mᴀɪɴ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ram}\n*╰──────────────◉◉➤*\n\n`;
    menuc += `*│ 📍 Command :* \`alive\`\n*│ 📃 Usage :* *Check bot online or no.*\n\n`;
    menuc += `*│ 📍 Command :* \`ping\`\n*│ 📃 Usage :* *Check bot's speed.*\n\n`;
    menuc += `*│ 📍 Command :* \`menu\`\n*│ 📃 Usage :* *Get bot's command list.*\n\n`;
    menuc += `*│ 📍 Command :* \`system\`\n*│ 📃 Usage :* *Get bot's system information.*\n\n`;

    const buttons = [
      { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: "MENU COMMAND" }, type: 1 },
      { buttonId: `${config.PREFIX}help`, buttonText: { displayText: "HELP CENTER" }, type: 1 }
    ];
    ...
    console.error('MainMenu command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Menu Error : -*\n${e.message}` }, { quoted: msg });
  }
  break;
}

// ==================== OWNER MENU (from GGKO) ====================
case 'ownermenu': {
  try {
    await socket.sendMessage(sender, { react: { text: "🔰", key: msg.key } });
    ...
    menuc += `*│ 📍 Command :* \`owner\`\n*│ 📃 Usage :* *Get bot's owners number.*\n\n`;
    menuc += `*│ 📍 Command :* \`setting\`\n*│ 📃 Usage :* *Bot settings panel.*\n\n`;
    menuc += `*│ 📍 Command :* \`boom\`\n*│ 📃 Usage :* *Send a message multiple times.*\n\n`;
    ...
    console.error('OwnerMenu command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Menu Error : -*\n${e.message}` }, { quoted: msg });
  }
  break;
}
...
case 'aimenu': {
  try {
    ...
    console.error('AiMenu command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Menu Error : -*\n${e.message}` }, { quoted: msg });
  }
  break;
}

// ==================== DOWNLOAD MENU (from GGKO) ====================
case 'downloadmenu': {
  try {
    await socket.sendMessage(sender, { react: { text: "⬇️", key: msg.key } });
    ...
    menuc += `*│ 📍 Command :* \`song\`\n*│ 📃 Usage :* *Download Audio.*\n\n`;
    menuc += `*│ 📍 Command :* \`video\`\n*│ 📃 Usage :* *Download Video.*\n\n`;
    menuc += `*│ 📍 Command :* \`tiktok\`\n*│ 📃 Usage :* *Download TikTok.*\n\n`;
    menuc += `*│ 📍 Command :* \`fb\`\n*│ 📃 Usage :* *Download Facebook.*\n\n`;
    menuc += `*│ 📍 Command :* \`ig\`\n*│ 📃 Usage :* *Download Instagram.*\n\n`;
    ...
    console.error('DownloadMenu command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Menu Error : -*\n${e.message}` }, { quoted: msg });
  }
  break;
}
...
case 'funmenu': {
  try {
    ...
    console.error('FunMenu command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Fun Menu Error : -*\n${e.message}` }, { quoted: msg });
  }
  break;
}

// ==================== GROUP MENU (from GGKO) ====================
case 'groupmenu': {
  try {
    await socket.sendMessage(sender, { react: { text: "👥", key: msg.key } });
    ...
    menuc += `*│ 📍 Command :* \`kick\`\n*│ 📃 Usage :* *Kick a member.*\n\n`;
    menuc += `*│ 📍 Command :* \`add\`\n*│ 📃 Usage :* *Add a member.*\n\n`;
    menuc += `*│ 📍 Command :* \`promote\`\n*│ 📃 Usage :* *Promote a member.*\n\n`;
    menuc += `*│ 📍 Command :* \`demote\`\n*│ 📃 Usage :* *Demote a member.*\n\n`;
    ...
    console.error('GroupMenu command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Menu Error : -*\n${e.message}` }, { quoted: msg });
  }
  break;
}

// ==================== OTHER MENU (from GGKO) ====================
case 'othermenu': {
  try {
    await socket.sendMessage(sender, { react: { text: "🧾", key: msg.key } });
    ...
    menuc += `*│ 📍 Command :* \`sticker\`\n*│ 📃 Usage :* *Create sticker.*\n\n`;
    ...
    console.error('OtherMenu command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Menu Error : -*\n${e.message}` }, { quoted: msg });
  }
  break;
}

// ==================== SEARCH MENU (from GGKO) ====================
case 'searchmenu': {
  try {
    await socket.sendMessage(sender, { react: { text: "🔍", key: msg.key } });
    ...
    let menuc = `*_🥏 ${botname} Sᴇᴀʀᴄʜ Mᴇɴᴜ_*\n\n*╭──────────────◉◉➤*\n*│ 🕒 \`Uptime\` : -* ${rtime}\n*│ 💾 \`RAM Usage\` : -* ${ram}\n*╰──────────────◉◉➤*\n\n`;
    menuc += `*│ 📍 Command :* \`google\`\n*│ 📃 Usage :* *Search on Google.*\n\n`;
    menuc += `*│ 📍 Command :* \`wiki\`\n*│ 📃 Usage :* *Search on Wikipedia.*\n\n`;
    menuc += `*│ 📍 Command :* \`gimage\`\n*│ 📃 Usage :* *Search Google Images.*\n\n`;
    ...
    console.error('SearchMenu command error:', e);
    await socket.sendMessage(sender, { text: `🚩 *Help Menu Error : -*\n${e.message}` }, { quoted: msg });
  }
  break;
}
