...
case 'menu': {
    try {       
       ...
       // menu of  first video note 👇 (optional - skip if fails)
        try {
            await socket.sendMessage(sender, {
            ...
            console.log("⚠️ Video note skipped:", videoErr?.message);
        }
...
`.trim();
        ...
        // --- 📤 generateWAMessageFromContent - fake PDF + list button (original format) ---
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.create({
                        ...
                        footer: proto.Message.InteractiveMessage.Footer.create({ text: `*${BOT_NAME}*` }),
                        header: proto.Message.InteractiveMessage.Header.create({
                            hasMediaAttachment: true,
        ...
        await socket.sendMessage(sender, { text: '❌ An error occurred in menu command.' }, { quoted: msg });
    }
    break;
}
// ==================== DOWNLOAD MENU ====================
