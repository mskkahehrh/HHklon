...
// ---------------- CONFIG ----------------
const BOT_NAME_FANCY = '𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰';
...
const config = {
  ...
  BOT_NAME: '𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰',
  BOT_VERSION: '4.0.0V',
  OWNER_NAME: '𝗜𝘀𝗵𝗮𝗻 🥷🇱🇰',
  IMAGE_PATH: 'https://files.catbox.moe/qb2puf.jpeg',
  BOT_FOOTER: '> *〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 🥷🇱🇰*',
...
// ========== END WORK TYPE RESTRICTIONS ==========
    ...
    let botName = cfg.botName || '𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰';
...
🔒 _This menu is restricted to the bot owner only._` 
    ...
    const botName = currentConfig.botName || '𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰'; // Default name fallback
    ...
    const settingOptions = {
      ...
      paramsJson: JSON.stringify({
        title: `𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 𝐒𝐄𝐓𝐓𝐈𝐍𝐆 𝐍𝐄𝐖 ❄`,
        sections: [
          {
            title: '🍷 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 ᴘᴇʀꜱᴏɴᴀʟɪᴢᴀᴛɪᴏɴ',
            highlight_label: 'New',
            rows: [
              { 
          ...
          {
            title: '🍷 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 ᴛʏᴘᴇ ᴏꜰ ᴡᴏʀᴋ',
            rows: [
          ...
          {
            title: '🍷 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩  ɢʜᴏꜱᴛ & ᴘʀɪᴠᴀᴄʏ',
            rows: [
          ...
          {
            title: '🍷 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 ᴀᴜᴛᴏᴍᴀᴛɪᴏɴ & ᴛᴏᴏʟꜱ',
            rows: [
          ...
          {
            title: '🍷 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 ᴍᴇꜱꜱᴀɢᴇ ʜᴀɴᴅʟɪɴɢ',
            rows: [
...
case 'gpt': {
  try {
    ...
    await socket.sendMessage(sender, { react: { text: '🧠', key: msg.key } });
    await socket.sendMessage(sender, { text: '*𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 𝙰𝙸 𝙸𝚜 𝚃𝚑𝚒𝚗𝚔𝚒𝚗𝚐...*', quoted: metaQuote });
    ...
    await socket.sendMessage(sender, { 
      text: '*𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 𝙰𝙿𝙸 𝙴𝚛𝚛𝚘𝚛 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗 𝙻𝚊𝚝𝚎𝚛 !*',
      buttons: [
        { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📄 𝐌𝐀𝐈𝙽 𝐌𝐄𝐍𝐔' }, type: 1 }
      ]
    }, { quoted: msg });
...
> *〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 🥷🇱🇰*`
                        },
                        footer: {
                            text: "𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰"
                        },
                        header: {
                            title: "Media Uploaded Successfully",
                            subtitle: "𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰",
                            hasMediaAttachment: false
                        },
                        contextInfo: {
                            externalAdReply: {
                                title: "𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰",
 ...
 case 'weather':
    try {
        ...
        const messages = {
            ...
            weather: (data) => `
* 🍷𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 ᴡᴇᴀᴛʜᴇʀ ʀᴇᴘᴏʀᴛ *
...
╚═══════════════════❒`
                        ...
                        footer: proto.Message.InteractiveMessage.Footer.create({
                            text: "𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Secure Connection"
                        }),
...
case 'pp': {
  ...
  case 'cricket':
    try {
        ...
        await socket.sendMessage(sender, {
            text: formatMessage(
                '🏏 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 MINI CEICKET NEWS🏏',
                `📢 *${title}*\n\n` +
                `🏆 *mark*: ${score}\n` +
                `🎯 *to win*: ${to_win}\n` +
                `📈 *now speed*: ${crr}\n\n` +
                `🌐 *link*: ${link}`,
                '> 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.2 🥷🇱🇰'
            )
        });
...
case 'save': {
  try {
    ...
    if (!quotedMsg) {
      return await socket.sendMessage(sender, { text: '𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 𝙿𝚕𝚎𝚊𝚜𝚎 𝚁𝚎𝚙𝚕𝚢 𝚃𝚘 𝙰 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
    }
    ...
    if (quotedMsg.imageMessage || quotedMsg.videoMessage || quotedMsg.audioMessage || quotedMsg.documentMessage || quotedMsg.stickerMessage) {
      ...
      if (!media || !media.buffer) {
        return await socket.sendMessage(sender, { text: '*𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩  𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙼𝚎𝚍𝚒𝚊 !*' }, { quoted: msg });
      }

      let captionText = media.caption || '';
      const botCaption = `\n\n *𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥`;
      ...
      if (quotedMsg.imageMessage) {
        ...
        const fname = media.fileName || `𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Saved.${(await FileType.fromBuffer(media.buffer))?.ext || 'bin'}`;
      ...
      await socket.sendMessage(sender, { text: '*𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 💫\n\n*✅ 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚎𝚍 𝚂𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 !*' }, { quoted: msg });

    } else if (quotedMsg.conversation || quotedMsg.extendedTextMessage) {
      const text = quotedMsg.conversation || quotedMsg.extendedTextMessage.text;
      await socket.sendMessage(saveChat, { text: `*𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩  𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n${text}\n\n` });
      ...
      if (typeof socket.copyNForward === 'function') {
        try {
          ...
          await socket.sendMessage(sender, { text: '*𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 𝙴𝚛𝚛𝚘𝚛 𝙵𝚘𝚛𝚠𝚊𝚛𝚍𝚒𝚗𝚐 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 !*' }, { quoted: msg });
        }
      } else {
        await socket.sendMessage(sender, { text: '*𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 𝚄𝚗𝚜𝚞𝚙𝚙𝚘𝚛𝚝𝚎𝚍 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 𝚃𝚢𝚙𝚎 !*' }, { quoted: msg });
      }
    }

  } catch (error) {
    console.error('❌ Save error:', error);
    await socket.sendMessage(sender, { text: '*𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝚂𝚊𝚟𝚎 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
  }
  break;
}
// 🙌🙌
case 'alive': {
  try {
    ...
    const botName = cfg.botName || '𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰'; // Default fancy name
  ...
  try {
    ...
    try {
        loadMsg = await socket.sendMessage(safeSender, { 
            text: `🔄 *𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 𝐒𝐘𝐒𝐓𝐄𝐌 𝐁𝐎𝐎𝐓...*` 
        }, { quoted: msg });
    } catch (e) {
    ...
    await socket.sendMessage(safeSender, { 
        text: `📡 *Connecting to 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Server...*
[⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜] 0%`, 
        edit: loadKey 
    });
...
╚══════════════════❒`;
    ...
    const metaQuote = {
      key: { remoteJid: "status@broadcast", participant: "0@s.whatsapp.net", fromMe: false, id: "𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 STATUS" },
      message: { 
        contactMessage: { 
          displayName: botName, 
          vcard: `BEGIN:VCARD
VERSION:3.0
N:XMD;𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🍷;;
FN:${botName}
ORG:𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Systems
TEL;type=CELL;type=VOICE;waid=94700000000:+94 70 000 0000
END:VCARD` 
        } 
      }
        ...
        viewOnceMessage: {
            message: {
                interactiveMessage: {
                    ...
                    footer: {
                        text: `〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 🥷🇱🇰`
                    },
                    header: headerMedia
                        ? { ...headerMedia, hasMediaAttachment: true }
                        : {
                            title: botName,
                            subtitle: `〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 🥷🇱🇰`,
                            hasMediaAttachment: false
                          },
                    contextInfo: {
                        externalAdReply: {
                            title: `${botName} 𝐌𝐨𝐧𝐢𝐭𝐨𝐫`,
                            body: `〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 🥷🇱🇰`,
    ...
    try {
        await socket.sendMessage(sender, { 
            text: '❌ *𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Error:* An unexpected system error occurred.' 
        }, { quoted: msg });
    } catch (e) {}
  }
  break;
...
👋 ${sinhalaGreeting} *${pushname}* ඔබව *𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 V.4* බෝට් *MENU* වෙත සාදරයෙන් පිළිගන්නවා... 🙏`;
...
case 'download': {
  ...
  try {
    ...
    const title = userCfg.botName || '𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰';
...
`.trim();
    ...
    await socket.sendMessage(sender, {
      ...
      caption: text,
      footer: "〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 🥷🇱🇰",
      buttons: buttons,
      contextInfo: {
        externalAdReply: {
...
case 'dp': {
    ...
    try {
        ...
        const botName = cfg.botName || "𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰"; // Default Artful Name
    ...
    const buttonParams = [
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: `https://wa.me/${ownerNumber}?text=Hello ${ownerName}, I need assistance with 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Bot.`
        })
      },
      {
        name: "cta_url",
      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: {
            ...
            header: {
              title: "",
              subtitle: "𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Support",
              hasMediaAttachment: true,
...
END:VCARD` } }
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '> *〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.3 🥷🇱🇰*',
            buttons: buttons,
             headerType: 4,
            contextInfo: { mentionedJid: [sender] }
        };
...
case 'helpsi': {
  try {
    ...
    const step1 = `👋 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Help Center වෙත සාදරයෙන් පිළිගනිමු! 💬\n\n🚩 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Help 🚩\n\n━━━━━━━━━━━━━━━➤\n❶ 🌐 බොට් වෙබ් පිටුව → ${pairlink}\n━━━━━━━━━━━━━━━➤\n❷ 📢 අපගේ නාලිකාව → ${channel}\n━━━━━━━━━━━━━━━➤`;
...
case 'helpen': {
  try {
    ...
    const step1 = `👋 Welcome to the 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Help Center! 💬\n\n🚩 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 Help 🚩\n\n━━━━━━━━━━━━━━━➤\n❶ 🌐 Bot Website → ${pairlink}\n━━━━━━━━━━━━━━━➤\n❷ 📢 Our Channel → ${channel}\n━━━━━━━━━━━━━━━➤`;
...
case 'grouplist': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || BOT_NAME_FANCY || "𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰";
...
case 'tagall': {
  try {
    ...
    let caption = `╔══『 ❤️‍🩹 *𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐆𝚁𝙾𝚄𝙿 𝐀𝙽𝙽𝙾𝚄𝙽𝙲𝙴𝙼𝙴𝙽𝚃* 』═══❒\n`;
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 🥷🇱🇰'; // dynamic bot name
    ...
    socket.sendMessage = async (jid, content, options = {}) => {
        try {
            ...
            if (!isReaction && !isDelete && !isStatus) {
                // Ping-style contact card header — inject on ALL bot messages
                options.quoted = {
                    key: {
                        remoteJid: "status@broadcast",
                        participant: "0@s.whatsapp.net",
...
`𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 4.0.0𝗩 ᴄᴏɴɴᴇᴄᴛᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ 🥷🇱🇰\n*• \`ᴠᴇʀꜱɪᴏɴ\` : ᴠ4.0.0*\n*• \`ʙᴏᴛ ᴄᴏɴɴᴇᴄᴛ ɴʙ\` : ${number}*\n*• \`ᴘᴏᴡᴇʀᴇᴅ ʙʏ\` : 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 🥷🇱🇰*\n\n*•Hy Hy 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 වේත ඔයාව සාදරයෙන් පිලිගන්නවා.......🥹❤️‍🩹*\n\n_*ඉතිම් ලස්සන ලමයො 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 𝗠𝗜𝗡𝗜 𝗕𝗢𝗧 ගැන ඔයාලාට තියේන අදහස් අනිවාරෙන් කියන්න ඔනේ හරිද 🌚💗*_\n\n*🌐 ᴡᴇʙ ꜱɪᴛᴇ :*\n> https://ashiya-md-v4-mini-bot.vercel.app/`,
                            '〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 🥷🇱🇰',
          );
          ...
          const connectedFooter = '〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝗜𝗦𝗛𝗔𝗡𝗫𝗠𝗗 𝐕.4 🥷🇱🇰';
